...
namespace StudentManagementSystem
{
    public partial class Student : Form
    {
        ...
        private void btnSubmitStudentInfo_Click(object sender, EventArgs e)
        {
         ...
         values('" + this.txtInputId.Text + "', '" + this.txtStudentName.Text + "'," + this.txtAge.Text + ", '" + this.txtGuardian.Text + "', '" + txtNumber.Text + "', '" + this.txtEmail.Text + "', '" + this.txtAddress.Text + "', '" + this.dtpJoin.Text + "', '" + this.dtpEnd.Text + "', " + this.txtFees.Text + ",'" + this.txtPassword.Text + "','"+this.cmboxSelectClassID.Text+"');";
