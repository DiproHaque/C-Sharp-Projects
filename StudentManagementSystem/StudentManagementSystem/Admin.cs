    ...
    public partial class Admin : Form
    {
        ...
        private void btnStudentDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string name = this.dgvStudentUpdateDelete.CurrentRow.Cells[2].Value.ToString();
            ...
            try
            {
                ...
                if (decision)
                {
                    ...
                    if (dt.Rows.Count == 1)
                    {
                        ...
                        {
                            MessageBox.Show("Student Data Update Error");
                        }
                    }
                    else if (dt.Rows.Count == 0)
                    {
        ...
        {
            this.SqlQurey2 = @"select * from teacher;";
            Ds2 = this.Da2.ExecuteQuery(SqlQurey2);
            this.dgvTeacherUpdate.AutoGenerateColumns = false;
            this.dgvTeacherUpdate.DataSource = Ds2.Tables[0];
        }

        private void btnTeacherUpdateSearch_Click(object sender, EventArgs e)
        {
            this.SqlQurey2 = @"select* from teacher where teacher_id = '" + this.txtTeacherSearchID.Text + "';";
            Ds2 = this.Da2.ExecuteQuery(SqlQurey2);
            this.dgvTeacherUpdate.AutoGenerateColumns = false;
            this.dgvTeacherUpdate.DataSource = Ds2.Tables[0];
        }
        ...
        private void btnTeacherDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string id = this.dgvTeacherUpdate.CurrentRow.Cells[0].Value.ToString();
                string name = this.dgvTeacherUpdate.CurrentRow.Cells[1].Value.ToString();
                this.SqlQurey2 = @"delete from teacher where teacher_id='" + id + "';";
                int row = Da2.ExecuteUpdateQuery(SqlQurey2);
                if (row == 1)
                {
                    MessageBox.Show(name + " has been Successfully Remove");
        ...
        private void btnTeacherUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (decision)
                {
                    this.SqlQurey2 = @"select* from teacher where teacher_id = '" + this.txtTeacherId.Text + "';";
                    DataTable dt = this.Da2.ExecuteQueryTable(this.SqlQurey2);

                    if (dt.Rows.Count == 1)
                    {
                        //Update operation
                        this.SqlQurey2 = @"update teacher
                                         set teacher_name ='" + this.txtTeacherName.Text + @"',
                                         teacher_age = " + this.txtTeacherAge.Text + @",
                                         teacher_number='" + this.txtTeacherNumber.Text + @"',
                                         teacher_email='" + this.txtTeacherEmail.Text + @"',
                                         teacher_address='" + this.txtTeacherAddress.Text + @"',
                                         teacher_joindate='" + this.txtTeacherJoin.Text + @"',                                       
                                         teacher_salary='" + this.txtTeacherSalary.Text + @"',
                                         teacher_password='" + this.txtTeacherPassword.Text + @"'
                                         where teacher_id ='" + this.txtTeacherId.Text + "';";
                        int row = this.Da2.ExecuteUpdateQuery(SqlQurey2);
                        if (row == 1)
                        {
                        ...
                        {
                            MessageBox.Show("Teacher Data Update Error");
                        }
                    }
                    else if (dt.Rows.Count == 0)
                    {
        ...
        private void dgvTeacherUpdate_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.txtTeacherEmail.Text = this.dgvTeacherUpdate.CurrentRow.Cells[2].Value.ToString();       
            this.txtTeacherNumber.Text = this.dgvTeacherUpdate.CurrentRow.Cells[3].Value.ToString();
            this.txtTeacherAddress.Text = this.dgvTeacherUpdate.CurrentRow.Cells[4].Value.ToString();
            this.txtTeacherSalary.Text = this.dgvTeacherUpdate.CurrentRow.Cells[5].Value.ToString();
            this.txtTeacherAge.Text = this.dgvTeacherUpdate.CurrentRow.Cells[6].Value.ToString();
            this.txtTeacherJoin.Text = this.dgvTeacherUpdate.CurrentRow.Cells[7].Value.ToString();
